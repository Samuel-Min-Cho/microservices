...
import Business.ReInviteFriend;
...
public class HoldResource {
    ...
    public String getXml(@PathParam("code") String code, @PathParam("friendName") String friendName) {
        ...
        ReInviteFriend invite = new ReInviteFriend();
        ReInvited friend = invite.getFriend(code, friendName);
        if (friend == null) {
            return (null);
        }
        ...
        try {
            ...
            jaxbContext = JAXBContext.newInstance(ReInvited.class);
    ...
    @Path("update")
    public String update(@FormParam("code") String code, @FormParam("friendName") String friendName) {
        System.out.println("POST : code : " + code + ", friendName : " + friendName);
        ReInviteFriend invite = new ReInviteFriend();
        boolean bs = invite.ReInvite(code, friendName);
        if (bs) {
            return ("Inserted");
        } else {
            return ("Not inserted");
